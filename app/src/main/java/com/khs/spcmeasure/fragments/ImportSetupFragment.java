...
import com.khs.spcmeasure.ProductAdapter;
import com.khs.spcmeasure.ProductLoader;
 ...
 *
 */
public class ImportSetupFragment extends ListFragment 
	implements OnQueryTextListener, OnCloseListener, LoaderManager.LoaderCallbacks<List<Product>>{
	
	private static final String TAG = "ImportSetupFragment";
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		inflater.inflate(R.menu.frag_imp_setup, menu);
	...
	public void importSetup() {			
		// confirm with user
		String message = "Are you sure you want to Import the " + getListView().getCheckedItemCount() + " selected setup(s)?";
