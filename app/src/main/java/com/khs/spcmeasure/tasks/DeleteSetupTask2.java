...
import com.khs.spcmeasure.PieceListFragment;
 ...
 *
 */
public class DeleteSetupTask2 extends AsyncTask <Long, Void, Void>{
	private Context mContext;
	private PieceListFragment mPieceListFrag;
	
	private ProgressDialog pDialog;	
	
	// constructor
	public DeleteSetupTask2(Context context, PieceListFragment pieceListfrag) {
		super();
		this.mContext = context;
		this.mPieceListFrag = pieceListfrag;
	}
