...
public class ImportSetupTask extends AsyncTask<Long, String, JSONObject>{
	...
	// private static String url = "http://thor.magna.global/spc/getSetupByProdId.php?prodId=";
	private static String url = "http://thor.magna.global/spc/get_setup.php?prodId=";
